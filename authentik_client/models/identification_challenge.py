...
class IdentificationChallenge(BaseModel):
    ...
    pending_user_identifier: Optional[StrictStr] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if pending_user_identifier (nullable) is None
        # and model_fields_set contains the field
        if self.pending_user_identifier is None and "pending_user_identifier" in self.model_fields_set:
            _dict['pending_user_identifier'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "response_errors": {
                _k: [ErrorDetail.from_dict(_item) for _item in _v] if _v is not None else None
                for _k, _v in obj["response_errors"].items()
            }
            if obj.get("response_errors") is not None
            else None,
            "user_fields": obj.get("user_fields"),
            "pending_user_identifier": obj.get("pending_user_identifier"),
