...
class GoogleChromeConnector(BaseModel):
    """
    ...
    chrome_url: Optional[StrictStr] = Field(description="Full URL to be used in Google Workspace configuration")
    __properties: ClassVar[List[str]] = ["connector_uuid", "name", "enabled", "component", "verbose_name", "verbose_name_plural", "meta_model_name", "credentials", "chrome_url"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if chrome_url (nullable) is None
        # and model_fields_set contains the field
        if self.chrome_url is None and "chrome_url" in self.model_fields_set:
            _dict['chrome_url'] = None
