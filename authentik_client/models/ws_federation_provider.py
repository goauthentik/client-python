...
from authentik_client.models.saml_version_enum import SamlVersionEnum
...
class WSFederationProvider(BaseModel):
    ...
    saml_version: Optional[SamlVersionEnum] = Field(default=None, description="SAML assertion version to issue in the security token. Microsoft Entra ID and classic ADFS-style relying parties typically require SAML 1.1.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "saml_version": obj.get("saml_version"),
