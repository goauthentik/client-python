...
class SystemInfo(BaseModel):
    ...
    base_url: StrictStr = Field(description="Configured external base URL. Can be empty")
    __properties: ClassVar[List[str]] = ["http_headers", "http_host", "http_is_secure", "runtime", "brand", "server_time", "embedded_outpost_disabled", "embedded_outpost_host", "base_url"]
