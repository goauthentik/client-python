...
class GoogleWorkspaceProviderRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "property_mappings", "property_mappings_group", "delegated_subject", "credentials", "scopes", "exclude_users_service_account", "filter_group", "user_delete_action", "group_delete_action", "default_group_email_domain", "sync_page_size", "sync_page_timeout", "dry_run", "discovery_enabled"]
