...
class SCIMProviderRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "property_mappings", "property_mappings_group", "url", "verify_certificates", "token", "auth_mode", "auth_oauth", "auth_oauth_params", "compatibility_mode", "service_provider_config_cache_timeout", "exclude_users_service_account", "sync_page_size", "sync_page_timeout", "group_filters", "dry_run"]
