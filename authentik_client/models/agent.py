...
class Agent(BaseModel):
    ...
    token_identifier: Optional[StrictStr] = Field(description="Identifier of the agent's API token, so its key can be retrieved/copied later.")
    __properties: ClassVar[List[str]] = ["pk", "username", "name", "is_active", "last_login", "email", "attributes", "uid", "uuid", "expiring", "expires", "parent", "policy_behavior", "token_identifier"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if token_identifier (nullable) is None
        # and model_fields_set contains the field
        if self.token_identifier is None and "token_identifier" in self.model_fields_set:
            _dict['token_identifier'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parent": PartialUser.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
