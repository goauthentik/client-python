...
class PaginatedLifecycleIterationList(BaseModel):
    """
    PaginatedLifecycleIterationList
    """ # noqa: E501
    pagination: Pagination
    results: List[LifecycleIteration]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [LifecycleIteration.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
