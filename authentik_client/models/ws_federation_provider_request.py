...
class WSFederationProviderRequest(BaseModel):
    """
    ...
    reply_url: Annotated[str, Field(min_length=1, strict=True)]
    wtrealm: Annotated[str, Field(min_length=1, strict=True)]
