...
class AppEnum(str, Enum):
    ...
    AUTHENTIK_DOT_ENTERPRISE_DOT_AGENTS = 'authentik.enterprise.agents'
    ...
    AUTHENTIK_DOT_ENTERPRISE_DOT_PROVIDERS_DOT_WS_FEDERATION = 'authentik.enterprise.providers.ws_federation'
    AUTHENTIK_DOT_ENTERPRISE_DOT_REPORTS = 'authentik.enterprise.reports'
    AUTHENTIK_DOT_ENTERPRISE_DOT_REQUESTS = 'authentik.enterprise.requests'
    AUTHENTIK_DOT_ENTERPRISE_DOT_STAGES_DOT_ACCOUNT_LOCKDOWN = 'authentik.enterprise.stages.account_lockdown'
