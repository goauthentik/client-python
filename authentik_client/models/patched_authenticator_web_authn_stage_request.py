...
class PatchedAuthenticatorWebAuthnStageRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "configure_flow", "friendly_name", "user_verification", "authenticator_attachment", "resident_key_requirement", "hints", "device_type_restrictions", "prevent_duplicate_devices", "max_attempts"]
