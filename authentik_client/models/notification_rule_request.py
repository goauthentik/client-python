...
class NotificationRuleRequest(BaseModel):
    ...
    group: Optional[UUID] = Field(default=None, description="Define which group of users this notification should be sent and shown to. If left empty, Notification won't ben sent.")
