...
class PaginatedFleetConnectorList(BaseModel):
    """
    PaginatedFleetConnectorList
    """ # noqa: E501
    pagination: Pagination
    results: List[FleetConnector]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [FleetConnector.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
