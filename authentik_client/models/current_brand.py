...
class CurrentBrand(BaseModel):
    ...
    flow_lockdown: Optional[StrictStr] = None
    default_locale: StrictStr
    flags: CurrentBrandFlags
    __properties: ClassVar[List[str]] = ["matched_domain", "branding_title", "branding_logo", "branding_logo_themed_urls", "branding_favicon", "branding_favicon_themed_urls", "branding_custom_css", "ui_footer_links", "ui_theme", "flow_authentication", "flow_invalidation", "flow_recovery", "flow_unenrollment", "flow_user_settings", "flow_device_code", "flow_lockdown", "default_locale", "flags"]
