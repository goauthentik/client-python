...
class Provider(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if invalidation_flow (nullable) is None
        # and model_fields_set contains the field
        if self.invalidation_flow is None and "invalidation_flow" in self.model_fields_set:
            _dict['invalidation_flow'] = None
