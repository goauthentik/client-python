...
class PatchedSettingsRequest(BaseModel):
    ...
    base_url: Optional[Annotated[str, Field(strict=True, max_length=200)]] = Field(default=None, description="Configure the base URL under which this authentik instance is reachable, e.g. https://authentik.company")
