...
class UserSelf(BaseModel):
    ...
    is_current: StrictBool = Field(description="Return whether this user owns the current browser session.")
    ...
    __properties: ClassVar[List[str]] = ["pk", "username", "name", "is_active", "is_superuser", "is_current", "groups", "roles", "email", "avatar", "uid", "settings", "type", "system_permissions"]
