...
class PatchedMicrosoftEntraProviderRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "property_mappings", "property_mappings_group", "client_id", "client_secret", "tenant_id", "exclude_users_service_account", "filter_group", "user_delete_action", "group_delete_action", "sync_page_size", "discovery_enabled", "sync_page_timeout", "dry_run"]
