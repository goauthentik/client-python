...
class OAuthSourceRequest(BaseModel):
    ...
    request_token_url: Optional[StrictStr] = Field(default=None, description="URL used to request the initial token. This URL is only required for OAuth 1.")
    authorization_url: Optional[StrictStr] = Field(default=None, description="URL the user is redirect to to conest the flow.")
    access_token_url: Optional[StrictStr] = Field(default=None, description="URL used by authentik to retrieve tokens.")
    profile_url: Optional[StrictStr] = Field(default=None, description="URL used by authentik to get user information.")
