...
class UserAccountLockdownRequest(BaseModel):
    """
    Choose the target account before starting the lockdown flow.
    """ # noqa: E501
    user: Optional[StrictInt] = Field(default=None, description="User to lock. If omitted, locks the current user (self-service).")
