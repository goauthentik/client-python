...
class AuthenticatorSMSStage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pk", "name", "component", "verbose_name", "verbose_name_plural", "meta_model_name", "flow_set", "configure_flow", "friendly_name", "provider", "from_number", "account_sid", "auth_type", "verify_only", "mapping"]
