...
class NotificationRule(BaseModel):
    ...
    destination_group_obj: Optional[Group]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if destination_group_obj (nullable) is None
        # and model_fields_set contains the field
        if self.destination_group_obj is None and "destination_group_obj" in self.model_fields_set:
            _dict['destination_group_obj'] = None
