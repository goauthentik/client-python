...
class SourceStage(BaseModel):
    ...
    resume_on_match_failures: Optional[List[ResumeOnMatchFailuresEnum]] = Field(default=None, description="Source matching failure reasons for which the flow should resume.")
    __properties: ClassVar[List[str]] = ["pk", "name", "component", "verbose_name", "verbose_name_plural", "meta_model_name", "flow_set", "source", "resume_timeout", "resume_on_match_failures"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resume_on_match_failures": obj.get("resume_on_match_failures")
        })
        return _obj
