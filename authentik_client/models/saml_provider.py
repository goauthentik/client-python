...
class SAMLProvider(BaseModel):
    ...
    issuer_override: Optional[StrictStr] = Field(default=None, description="Also known as EntityID. Providing a value overrides the default issuer generated by authentik.")
    ...
    url_issuer: StrictStr = Field(description="Get Issuer/EntityID URL")
    url_unified: StrictStr = Field(description="Get unified SAML endpoint URL (handles SSO and SLO)")
    url_unified_init: StrictStr = Field(description="Get IdP-initiated SAML URL")
    ...
    __properties: ClassVar[List[str]] = ["pk", "name", "authentication_flow", "authorization_flow", "invalidation_flow", "property_mappings", "component", "assigned_application_slug", "assigned_application_name", "assigned_backchannel_application_slug", "assigned_backchannel_application_name", "verbose_name", "verbose_name_plural", "meta_model_name", "acs_url", "sls_url", "audience", "issuer_override", "assertion_valid_not_before", "assertion_valid_not_on_or_after", "session_valid_not_on_or_after", "name_id_mapping", "authn_context_class_ref_mapping", "digest_algorithm", "signature_algorithm", "signing_kp", "verification_kp", "encryption_kp", "sign_assertion", "sign_response", "sign_logout_request", "sign_logout_response", "sp_binding", "sls_binding", "logout_method", "default_relay_state", "default_name_id_policy", "url_download_metadata", "url_issuer", "url_unified", "url_unified_init", "url_sso_post", "url_sso_redirect", "url_sso_init", "url_slo_post", "url_slo_redirect"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "issuer_override": obj.get("issuer_override"),
            ...
            "url_issuer": obj.get("url_issuer"),
            "url_unified": obj.get("url_unified"),
            "url_unified_init": obj.get("url_unified_init"),
