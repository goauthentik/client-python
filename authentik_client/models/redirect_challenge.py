...
class RedirectChallenge(BaseModel):
    ...
    to: StrictStr
    final_redirect: Optional[StrictBool] = False
    __properties: ClassVar[List[str]] = ["flow_info", "component", "response_errors", "to", "final_redirect"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "to": obj.get("to"),
            "final_redirect": obj.get("final_redirect") if obj.get("final_redirect") is not None else False
        })
        return _obj
