...
class SCIMProvider(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pk", "name", "property_mappings", "property_mappings_group", "component", "assigned_backchannel_application_slug", "assigned_backchannel_application_name", "verbose_name", "verbose_name_plural", "meta_model_name", "url", "verify_certificates", "auth_mode", "auth_oauth", "auth_oauth_params", "compatibility_mode", "service_provider_config_cache_timeout", "exclude_users_service_account", "sync_page_size", "sync_page_timeout", "group_filters", "dry_run"]
