...
MODELREQUEST_ONE_OF_SCHEMAS = ["GoogleWorkspaceProviderRequest", "LDAPProviderRequest", "MicrosoftEntraProviderRequest", "OAuth2ProviderRequest", "ProxyProviderRequest", "RACProviderRequest", "RadiusProviderRequest", "SAMLProviderRequest", "SCIMProviderRequest", "SSFProviderRequest", "WSFederationProviderRequest"]
...
class ModelRequest(BaseModel):
    ...
    # data type: WSFederationProviderRequest
    oneof_schema_11_validator: Optional[WSFederationProviderRequest] = None
    actual_instance: Optional[Union[GoogleWorkspaceProviderRequest, LDAPProviderRequest, MicrosoftEntraProviderRequest, OAuth2ProviderRequest, ProxyProviderRequest, RACProviderRequest, RadiusProviderRequest, SAMLProviderRequest, SCIMProviderRequest, SSFProviderRequest, WSFederationProviderRequest]] = None
    one_of_schemas: Set[str] = { "GoogleWorkspaceProviderRequest", "LDAPProviderRequest", "MicrosoftEntraProviderRequest", "OAuth2ProviderRequest", "ProxyProviderRequest", "RACProviderRequest", "RadiusProviderRequest", "SAMLProviderRequest", "SCIMProviderRequest", "SSFProviderRequest", "WSFederationProviderRequest" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, SSFProviderRequest):
            ...
            match += 1
        # validate data type: WSFederationProviderRequest
        if not isinstance(v, WSFederationProviderRequest):
            error_messages.append(f"Error! Input type `{type(v)}` is not `WSFederationProviderRequest`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in ModelRequest with oneOf schemas: GoogleWorkspaceProviderRequest, LDAPProviderRequest, MicrosoftEntraProviderRequest, OAuth2ProviderRequest, ProxyProviderRequest, RACProviderRequest, RadiusProviderRequest, SAMLProviderRequest, SCIMProviderRequest, SSFProviderRequest, WSFederationProviderRequest. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into WSFederationProviderRequest
        try:
            instance.actual_instance = WSFederationProviderRequest.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], GoogleWorkspaceProviderRequest, LDAPProviderRequest, MicrosoftEntraProviderRequest, OAuth2ProviderRequest, ProxyProviderRequest, RACProviderRequest, RadiusProviderRequest, SAMLProviderRequest, SCIMProviderRequest, SSFProviderRequest, WSFederationProviderRequest]]:
