...
class CaptchaStage(BaseModel):
    ...
    request_content_type: Optional[RequestContentTypeEnum] = None
    ...
    __properties: ClassVar[List[str]] = ["pk", "name", "component", "verbose_name", "verbose_name_plural", "meta_model_name", "flow_set", "public_key", "js_url", "api_url", "request_content_type", "interactive", "score_min_threshold", "score_max_threshold", "error_on_invalid_score"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "request_content_type": obj.get("request_content_type"),
