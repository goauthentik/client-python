...
class SAMLSource(BaseModel):
    ...
    issuer_override: Optional[StrictStr] = Field(default=None, description="Also known as Entity ID. Defaults to the Metadata URL.")
    url_issuer: StrictStr = Field(description="Get the resolved Issuer, falling back to the metadata URL when unset")
    ...
    force_authn: Optional[StrictBool] = Field(default=None, description="When enabled, the IdP will re-authenticate the user even if a session exists.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "force_authn": obj.get("force_authn"),
