...
class PaginatedRequestRuleBindingList(BaseModel):
    """
    PaginatedRequestRuleBindingList
    """ # noqa: E501
    pagination: Pagination
    results: List[RequestRuleBinding]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [RequestRuleBinding.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
