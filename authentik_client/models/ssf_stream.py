...
class SSFStream(BaseModel):
    ...
    """ # noqa: E501
    pk: UUID
    status: Optional[SSFStreamStatusEnum] = None
    provider: StrictInt
    ...
    iss: StrictStr
    __properties: ClassVar[List[str]] = ["pk", "status", "provider", "provider_obj", "delivery_method", "endpoint_url", "events_requested", "format", "aud", "iss"]
