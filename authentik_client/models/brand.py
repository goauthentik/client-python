...
class Brand(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if flow_user_switch (nullable) is None
        # and model_fields_set contains the field
        if self.flow_user_switch is None and "flow_user_switch" in self.model_fields_set:
            _dict['flow_user_switch'] = None
        ...
        # set to None if flow_lockdown (nullable) is None
        # and model_fields_set contains the field
        if self.flow_lockdown is None and "flow_lockdown" in self.model_fields_set:
            _dict['flow_lockdown'] = None

        # set to None if flow_request (nullable) is None
        # and model_fields_set contains the field
        if self.flow_request is None and "flow_request" in self.model_fields_set:
            _dict['flow_request'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "branding_map_tiles": obj.get("branding_map_tiles"),
            "flow_authentication": obj.get("flow_authentication"),
            "flow_user_switch": obj.get("flow_user_switch"),
            ...
            "flow_lockdown": obj.get("flow_lockdown"),
            "flow_request": obj.get("flow_request"),
