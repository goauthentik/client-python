...
class PatchedAgentRequest(BaseModel):
    ...
    name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="User's display name.")
    ...
    __properties: ClassVar[List[str]] = ["username", "name", "is_active", "last_login", "email", "attributes", "expiring", "expires"]
