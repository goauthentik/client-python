...
class AuthenticatorWebAuthnStage(BaseModel):
    ...
    resident_key_requirement: Optional[UserVerificationEnum] = None
    ...
    prevent_duplicate_devices: Optional[StrictBool] = Field(default=None, description="When enabled, a given device can only be registered once.")
    max_attempts: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = None
    __properties: ClassVar[List[str]] = ["pk", "name", "component", "verbose_name", "verbose_name_plural", "meta_model_name", "flow_set", "configure_flow", "friendly_name", "user_verification", "authenticator_attachment", "resident_key_requirement", "hints", "device_type_restrictions", "device_type_restrictions_obj", "prevent_duplicate_devices", "max_attempts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prevent_duplicate_devices": obj.get("prevent_duplicate_devices"),
