...
class PaginatedOAuth2DynamicClientRegistrationList(BaseModel):
    """
    PaginatedOAuth2DynamicClientRegistrationList
    """ # noqa: E501
    pagination: Pagination
    results: List[OAuth2DynamicClientRegistration]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [OAuth2DynamicClientRegistration.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
