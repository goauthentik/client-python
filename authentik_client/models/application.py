...
class Application(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pk", "pbm_uuid", "name", "slug", "provider", "provider_obj", "backchannel_providers", "backchannel_providers_obj", "launch_url", "open_in_new_tab", "meta_launch_url", "meta_icon", "meta_icon_url", "meta_icon_themed_urls", "meta_description", "meta_publisher", "policy_engine_mode", "group", "meta_hide"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if provider_obj (nullable) is None
        # and model_fields_set contains the field
        if self.provider_obj is None and "provider_obj" in self.model_fields_set:
            _dict['provider_obj'] = None
