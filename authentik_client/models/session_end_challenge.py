...
class SessionEndChallenge(BaseModel):
    ...
    overview_url: Optional[StrictStr] = None
    brand_name: StrictStr
    __properties: ClassVar[List[str]] = ["flow_info", "component", "response_errors", "pending_user", "pending_user_avatar", "application_name", "application_launch_url", "invalidation_flow_url", "overview_url", "brand_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "overview_url": obj.get("overview_url"),
