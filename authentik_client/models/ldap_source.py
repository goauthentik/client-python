...
class LDAPSource(BaseModel):
    ...
    sync_group_hierarchy: Optional[StrictBool] = Field(default=None, description="Sync group parentage/hierarchy from LDAP directories.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sync_group_hierarchy": obj.get("sync_group_hierarchy")
        })
        return _obj
