...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        ...
        "authentik_device_enroll": BearerAuthSetting,
        "authentik_device_federation": BearerAuthSetting,
    },
    total=False,
)
...
class Configuration:
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        if self.access_token is not None:
            auth['authentik_device_federation'] = {
                'type': 'bearer',
                'in': 'header',
                'key': 'Authorization',
                'value': 'Bearer ' + self.access_token
    ...
    def to_debug_report(self) -> str:
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 2026.8.0-rc7\n"\
               "SDK Package Version: 2026.8.0-rc7".\
