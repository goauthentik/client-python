...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.EndpointsApi(api_client)
    apple_independent_secure_enclave_request = authentik_client.AppleIndependentSecureEnclaveRequest() # AppleIndependentSecureEnclaveRequest | 

    try:
        api_response = api_instance.endpoints_agents_psso_ise_create(apple_independent_secure_enclave_request)
        print("The response of EndpointsApi->endpoints_agents_psso_ise_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EndpointsApi->endpoints_agents_psso_ise_create: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.EndpointsApi(api_client)
    uuid = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | A UUID string identifying this Apple Independent Secure Enclave.

    try:
        api_instance.endpoints_agents_psso_ise_destroy(uuid)
    except Exception as e:
        print("Exception when calling EndpointsApi->endpoints_agents_psso_ise_destroy: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **uuid** | **UUID**| A UUID string identifying this Apple Independent Secure Enclave. | 
...
> PaginatedAppleIndependentSecureEnclaveList endpoints_agents_psso_ise_list(apple_enclave_key_id=apple_enclave_key_id, ordering=ordering, page=page, page_size=page_size, search=search, user=user)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.EndpointsApi(api_client)
    apple_enclave_key_id = 'apple_enclave_key_id_example' # str |  (optional)
    ordering = 'ordering_example' # str | Which field to use when ordering the results. (optional)
    page = 56 # int | A page number within the paginated result set. (optional)
    page_size = 56 # int | Number of results to return per page. (optional)
    search = 'search_example' # str | A search term. (optional)
    ...
    try:
        api_response = api_instance.endpoints_agents_psso_ise_list(apple_enclave_key_id=apple_enclave_key_id, ordering=ordering, page=page, page_size=page_size, search=search, user=user)
        print("The response of EndpointsApi->endpoints_agents_psso_ise_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EndpointsApi->endpoints_agents_psso_ise_list: %s\n" % e)
```
...
> AppleIndependentSecureEnclave endpoints_agents_psso_ise_partial_update(uuid, patched_apple_independent_secure_enclave_request=patched_apple_independent_secure_enclave_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.EndpointsApi(api_client)
    uuid = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | A UUID string identifying this Apple Independent Secure Enclave.
    patched_apple_independent_secure_enclave_request = authentik_client.PatchedAppleIndependentSecureEnclaveRequest() # PatchedAppleIndependentSecureEnclaveRequest |  (optional)

    try:
        api_response = api_instance.endpoints_agents_psso_ise_partial_update(uuid, patched_apple_independent_secure_enclave_request=patched_apple_independent_secure_enclave_request)
        print("The response of EndpointsApi->endpoints_agents_psso_ise_partial_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EndpointsApi->endpoints_agents_psso_ise_partial_update: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.endpoints_agents_psso_ise_retrieve(uuid)
        print("The response of EndpointsApi->endpoints_agents_psso_ise_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EndpointsApi->endpoints_agents_psso_ise_retrieve: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.endpoints_agents_psso_ise_update(uuid, apple_independent_secure_enclave_request)
        print("The response of EndpointsApi->endpoints_agents_psso_ise_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EndpointsApi->endpoints_agents_psso_ise_update: %s\n" % e)
```
...
> List[UsedBy] endpoints_agents_psso_ise_used_by_list(uuid)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.endpoints_agents_psso_ise_used_by_list(uuid)
        print("The response of EndpointsApi->endpoints_agents_psso_ise_used_by_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EndpointsApi->endpoints_agents_psso_ise_used_by_list: %s\n" % e)
```
