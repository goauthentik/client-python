...
* `AUTHENTIK_CORE_DOT_OBJECTATTRIBUTE` (value: `'authentik_core.objectattribute'`)

* `AUTHENTIK_CORE_DOT_ACTOR` (value: `'authentik_core.actor'`)
...
* `AUTHENTIK_PROVIDERS_OAUTH2_DOT_OAUTH2DYNAMICCLIENTREGISTRATION` (value: `'authentik_providers_oauth2.oauth2dynamicclientregistration'`)
...
* `AUTHENTIK_AGENTS_DOT_AGENT` (value: `'authentik_agents.agent'`)

* `AUTHENTIK_ENDPOINTS_CONNECTORS_FLEET_DOT_FLEETCONNECTOR` (value: `'authentik_endpoints_connectors_fleet.fleetconnector'`)

* `AUTHENTIK_ENDPOINTS_CONNECTORS_GOOGLE_CHROME_DOT_GOOGLECHROMECONNECTOR` (value: `'authentik_endpoints_connectors_google_chrome.googlechromeconnector'`)
...
* `AUTHENTIK_LIFECYCLE_DOT_USEROFFBOARDING` (value: `'authentik_lifecycle.useroffboarding'`)
...
* `AUTHENTIK_PROVIDERS_WS_FEDERATION_DOT_WSFEDERATIONPROVIDER` (value: `'authentik_providers_ws_federation.wsfederationprovider'`)

* `AUTHENTIK_REPORTS_DOT_DATAEXPORT` (value: `'authentik_reports.dataexport'`)

* `AUTHENTIK_REQUESTS_DOT_REQUESTRULECHILDBINDING` (value: `'authentik_requests.requestrulechildbinding'`)

* `AUTHENTIK_REQUESTS_DOT_REQUESTRULEBINDING` (value: `'authentik_requests.requestrulebinding'`)

* `AUTHENTIK_REQUESTS_DOT_REQUESTRULE` (value: `'authentik_requests.requestrule'`)

* `AUTHENTIK_REQUESTS_DOT_GRANTREQUEST` (value: `'authentik_requests.grantrequest'`)

* `AUTHENTIK_STAGES_ACCOUNT_LOCKDOWN_DOT_ACCOUNTLOCKDOWNSTAGE` (value: `'authentik_stages_account_lockdown.accountlockdownstage'`)
