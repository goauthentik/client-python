...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.AdminApi(api_client)
    name = 'name_example' # str |  (optional)
    usage = authentik_client.UsageEnum() # UsageEnum |  (optional)
...
# **admin_models_list**
> List[App] admin_models_list(filter_has_attributes=filter_has_attributes)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.AdminApi(api_client)
    filter_has_attributes = True # bool |  (optional)

    try:
        api_response = api_instance.admin_models_list(filter_has_attributes=filter_has_attributes)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **filter_has_attributes** | **bool**|  | [optional] 
