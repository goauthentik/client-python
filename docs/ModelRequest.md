...
**grant_types** | [**List[GrantTypesEnum]**](GrantTypesEnum.md) |  | [optional] 
...
**issuer_override** | **str** | Also known as EntityID. Providing a value overrides the default issuer generated by authentik. | [optional] 
...
**push_verify_certificates** | **bool** |  | [optional] 
**reply_url** | **str** |  | 
**wtrealm** | **str** |  | 
