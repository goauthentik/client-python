...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    actions = [authentik_client.EventActions()] # List[EventActions] |  (optional)
    ...
    context_device = 'context_device_example' # str | Context Device Primary Key (optional)
...
------------- | ------------- | ------------- | -------------
 **action** | **str**|  | [optional] 
 **actions** | [**List[EventActions]**](EventActions.md)|  | [optional] 
 **brand_name** | **str**| Brand name | [optional] 
 **client_ip** | **str**|  | [optional] 
 **context_authorized_app** | **str**| Context Authorized application | [optional] 
 **context_device** | **str**| Context Device Primary Key | [optional] 
...
> EventStats events_events_stats_retrieve(count_steps, action=action, actions=actions, brand_name=brand_name, client_ip=client_ip, context_authorized_app=context_authorized_app, context_device=context_device, context_model_app=context_model_app, context_model_name=context_model_name, context_model_pk=context_model_pk, ordering=ordering, search=search, username=username)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.EventsApi(api_client)
    count_steps = ['count_steps_example'] # List[str] | Timedelta, format of 'weeks=3;days=2;hours=3,seconds=2'
    action = 'action_example' # str |  (optional)
    actions = [authentik_client.EventActions()] # List[EventActions] |  (optional)
    brand_name = 'brand_name_example' # str | Brand name (optional)
    client_ip = 'client_ip_example' # str |  (optional)
    ...
    try:
        api_response = api_instance.events_events_stats_retrieve(count_steps, action=action, actions=actions, brand_name=brand_name, client_ip=client_ip, context_authorized_app=context_authorized_app, context_device=context_device, context_model_app=context_model_app, context_model_name=context_model_name, context_model_pk=context_model_pk, ordering=ordering, search=search, username=username)
        print("The response of EventsApi->events_events_stats_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EventsApi->events_events_stats_retrieve: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **count_steps** | [**List[str]**](str.md)| Timedelta, format of &#39;weeks&#x3D;3;days&#x3D;2;hours&#x3D;3,seconds&#x3D;2&#39; | 
 **action** | **str**|  | [optional] 
 **actions** | [**List[EventActions]**](EventActions.md)|  | [optional] 
 **brand_name** | **str**| Brand name | [optional] 
 **client_ip** | **str**|  | [optional] 
...
> List[EventTopPerUser] events_events_top_per_user_list(action=action, actions=actions, brand_name=brand_name, client_ip=client_ip, context_authorized_app=context_authorized_app, context_device=context_device, context_model_app=context_model_app, context_model_name=context_model_name, context_model_pk=context_model_pk, ordering=ordering, search=search, top_n=top_n, username=username)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    ordering = 'ordering_example' # str | Which field to use when ordering the results. (optional)
    search = 'search_example' # str | A search term. (optional)
    top_n = 15 # int |  (optional) (default to 15)
    username = 'username_example' # str | Username (optional)

    try:
        api_response = api_instance.events_events_top_per_user_list(action=action, actions=actions, brand_name=brand_name, client_ip=client_ip, context_authorized_app=context_authorized_app, context_device=context_device, context_model_app=context_model_app, context_model_name=context_model_name, context_model_pk=context_model_pk, ordering=ordering, search=search, top_n=top_n, username=username)
 ...
 **ordering** | **str**| Which field to use when ordering the results. | [optional] 
 **search** | **str**| A search term. | [optional] 
 **top_n** | **int**|  | [optional] [default to 15]
 **username** | **str**| Username | [optional] 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    context_model_name = 'context_model_name_example' # str | Context Model Name (optional)
    context_model_pk = 'context_model_pk_example' # str | Context Model Primary Key (optional)
    history_days = 7 # int |  (optional) (default to 7)
    ordering = 'ordering_example' # str | Which field to use when ordering the results. (optional)
    search = 'search_example' # str | A search term. (optional)
    username = 'username_example' # str | Username (optional)
 ...
 **context_model_name** | **str**| Context Model Name | [optional] 
 **context_model_pk** | **str**| Context Model Primary Key | [optional] 
 **history_days** | **int**|  | [optional] [default to 7]
 **ordering** | **str**| Which field to use when ordering the results. | [optional] 
 **search** | **str**| A search term. | [optional] 
 **username** | **str**| Username | [optional] 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    severity = authentik_client.SeverityEnum() # SeverityEnum |  (optional)
...
from authentik_client.models.transport_mode_enum import TransportModeEnum
from authentik_client.rest import ApiException
from pprint import pprint
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.EventsApi(api_client)
    mode = authentik_client.TransportModeEnum() # TransportModeEnum |  (optional)
    name = 'name_example' # str |  (optional)
    ordering = 'ordering_example' # str | Which field to use when ordering the results. (optional)
    page = 56 # int | A page number within the paginated result set. (optional)
    page_size = 56 # int | Number of results to return per page. (optional)
