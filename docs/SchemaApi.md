...
from authentik_client.models.format_enum import FormatEnum
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    format = authentik_client.FormatEnum() # FormatEnum |  (optional)
    lang = authentik_client.LangEnum() # LangEnum |  (optional)
