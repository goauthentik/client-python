...
> PaginatedRequestableTargetList core_application_entitlements_requestable_list(app=app, name=name, ordering=ordering, page=page, page_size=page_size, pbm_uuid=pbm_uuid, search=search)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.core_application_entitlements_requestable_list(app=app, name=name, ordering=ordering, page=page, page_size=page_size, pbm_uuid=pbm_uuid, search=search)
        print("The response of CoreApi->core_application_entitlements_requestable_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CoreApi->core_application_entitlements_requestable_list: %s\n" % e)
```
...
> PaginatedApplicationList core_applications_requestable_list(group=group, meta_description=meta_description, meta_launch_url=meta_launch_url, meta_publisher=meta_publisher, name=name, ordering=ordering, page=page, page_size=page_size, search=search, slug=slug)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.core_applications_requestable_list(group=group, meta_description=meta_description, meta_launch_url=meta_launch_url, meta_publisher=meta_publisher, name=name, ordering=ordering, page=page, page_size=page_size, search=search, slug=slug)
        print("The response of CoreApi->core_applications_requestable_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CoreApi->core_applications_requestable_list: %s\n" % e)
```
...
# **core_brands_list**
> PaginatedBrandList core_brands_list(brand_uuid=brand_uuid, branding_default_flow_background=branding_default_flow_background, branding_favicon=branding_favicon, branding_logo=branding_logo, branding_title=branding_title, client_certificates=client_certificates, default=default, domain=domain, flow_authentication=flow_authentication, flow_device_code=flow_device_code, flow_invalidation=flow_invalidation, flow_lockdown=flow_lockdown, flow_recovery=flow_recovery, flow_request=flow_request, flow_unenrollment=flow_unenrollment, flow_user_settings=flow_user_settings, flow_user_switch=flow_user_switch, ordering=ordering, page=page, page_size=page_size, search=search, web_certificate=web_certificate)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    flow_lockdown = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID |  (optional)
    flow_recovery = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID |  (optional)
    flow_request = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID |  (optional)
    ...
    flow_user_switch = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID |  (optional)
    ordering = 'ordering_example' # str | Which field to use when ordering the results. (optional)
    page = 56 # int | A page number within the paginated result set. (optional)
    page_size = 56 # int | Number of results to return per page. (optional)
    search = 'search_example' # str | A search term. (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.CoreApi(api_client)
    object_attribute_request = authentik_client.ObjectAttributeRequest() # ObjectAttributeRequest | 

    try:
        api_response = api_instance.core_object_attributes_create(object_attribute_request)
        print("The response of CoreApi->core_object_attributes_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CoreApi->core_object_attributes_create: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.CoreApi(api_client)
    attribute_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | A UUID string identifying this Object Attribute.

    try:
        api_instance.core_object_attributes_destroy(attribute_id)
    except Exception as e:
        print("Exception when calling CoreApi->core_object_attributes_destroy: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **attribute_id** | **UUID**| A UUID string identifying this Object Attribute. | 
...
> PaginatedObjectAttributeList core_object_attributes_list(enabled=enabled, object_type__app_label=object_type__app_label, object_type__model=object_type__model, ordering=ordering, page=page, page_size=page_size, search=search)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    object_type__app_label = 'object_type__app_label_example' # str |  (optional)
    object_type__model = 'object_type__model_example' # str |  (optional)
    ordering = 'ordering_example' # str | Which field to use when ordering the results. (optional)
    page = 56 # int | A page number within the paginated result set. (optional)
    page_size = 56 # int | Number of results to return per page. (optional)
    search = 'search_example' # str | A search term. (optional)
    ...
    try:
        api_response = api_instance.core_object_attributes_list(enabled=enabled, object_type__app_label=object_type__app_label, object_type__model=object_type__model, ordering=ordering, page=page, page_size=page_size, search=search)
        print("The response of CoreApi->core_object_attributes_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CoreApi->core_object_attributes_list: %s\n" % e)
```
 ...
 **object_type__app_label** | **str**|  | [optional] 
 **object_type__model** | **str**|  | [optional] 
 **ordering** | **str**| Which field to use when ordering the results. | [optional] 
 **page** | **int**| A page number within the paginated result set. | [optional] 
 **page_size** | **int**| Number of results to return per page. | [optional] 
 **search** | **str**| A search term. | [optional] 
...
> ObjectAttribute core_object_attributes_partial_update(attribute_id, patched_object_attribute_request=patched_object_attribute_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.CoreApi(api_client)
    attribute_id = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | A UUID string identifying this Object Attribute.
    patched_object_attribute_request = authentik_client.PatchedObjectAttributeRequest() # PatchedObjectAttributeRequest |  (optional)

    try:
        api_response = api_instance.core_object_attributes_partial_update(attribute_id, patched_object_attribute_request=patched_object_attribute_request)
        print("The response of CoreApi->core_object_attributes_partial_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CoreApi->core_object_attributes_partial_update: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.core_object_attributes_retrieve(attribute_id)
        print("The response of CoreApi->core_object_attributes_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CoreApi->core_object_attributes_retrieve: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.core_object_attributes_update(attribute_id, object_attribute_request)
        print("The response of CoreApi->core_object_attributes_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CoreApi->core_object_attributes_update: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    intent = authentik_client.IntentEnum() # IntentEnum |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.CoreApi(api_client)
    identifier = 'identifier_example' # str | 
    patched_token_request = authentik_client.PatchedTokenRequest() # PatchedTokenRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.CoreApi(api_client)
    identifier = 'identifier_example' # str | 
    token_set_key_request = authentik_client.TokenSetKeyRequest() # TokenSetKeyRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.CoreApi(api_client)
    transaction_application_request = authentik_client.TransactionApplicationRequest() # TransactionApplicationRequest | 
...
> Link core_users_account_lockdown_create(user_account_lockdown_request=user_account_lockdown_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.CoreApi(api_client)
    user_account_lockdown_request = authentik_client.UserAccountLockdownRequest() # UserAccountLockdownRequest |  (optional)

    try:
        api_response = api_instance.core_users_account_lockdown_create(user_account_lockdown_request=user_account_lockdown_request)
        print("The response of CoreApi->core_users_account_lockdown_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CoreApi->core_users_account_lockdown_create: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **user_account_lockdown_request** | [**UserAccountLockdownRequest**](UserAccountLockdownRequest.md)|  | [optional] 
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.CoreApi(api_client)
    user_request = authentik_client.UserRequest() # UserRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    search = 'search_example' # str | A search term. (optional)
    type = [authentik_client.UserTypeEnum()] # List[UserTypeEnum] |  (optional)
 ...
 **search** | **str**| A search term. | [optional] 
 **type** | [**List[UserTypeEnum]**](UserTypeEnum.md)|  | [optional] 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.CoreApi(api_client)
    id = 56 # int | A unique integer value identifying this User.
    impersonation_request = authentik_client.ImpersonationRequest() # ImpersonationRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.CoreApi(api_client)
    id = 56 # int | A unique integer value identifying this User.
    patched_user_request = authentik_client.PatchedUserRequest() # PatchedUserRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.CoreApi(api_client)
    user_service_account_request = authentik_client.UserServiceAccountRequest() # UserServiceAccountRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.CoreApi(api_client)
    id = 56 # int | A unique integer value identifying this User.
    user_password_set_request = authentik_client.UserPasswordSetRequest() # UserPasswordSetRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.CoreApi(api_client)
    id = 56 # int | A unique integer value identifying this User.
    user_password_hash_set_request = authentik_client.UserPasswordHashSetRequest() # UserPasswordHashSetRequest | 

    try:
        api_instance.core_users_set_password_hash_create(id, user_password_hash_set_request)
    except Exception as e:
        print("Exception when calling CoreApi->core_users_set_password_hash_create: %s\n" % e)
```
...
> UserSwitchResponse core_users_switch_create(next=next, user_switch_request=user_switch_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    user_switch_request = authentik_client.UserSwitchRequest() # UserSwitchRequest |  (optional)

    try:
        api_response = api_instance.core_users_switch_create(next=next, user_switch_request=user_switch_request)
        print("The response of CoreApi->core_users_switch_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CoreApi->core_users_switch_create: %s\n" % e)
```
