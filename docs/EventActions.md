...
* `USER_OFFBOARDED` (value: `'user_offboarded'`)
...
* `ACCESS_REQUEST_CREATED` (value: `'access_request_created'`)

* `ACCESS_REQUEST_APPROVED` (value: `'access_request_approved'`)

* `ACCESS_REQUEST_DENIED` (value: `'access_request_denied'`)

* `ACCESS_REQUEST_REVOKED` (value: `'access_request_revoked'`)
