...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.ProvidersApi(api_client)
    id = 56 # int | A unique integer value identifying this Microsoft Entra Provider.
    patched_microsoft_entra_provider_request = authentik_client.PatchedMicrosoftEntraProviderRequest() # PatchedMicrosoftEntraProviderRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.providers_microsoft_entra_sync_object_create(id, sync_object_request)
        print("The response of ProvidersApi->providers_microsoft_entra_sync_object_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProvidersApi->providers_microsoft_entra_sync_object_create: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.ProvidersApi(api_client)
    microsoft_entra_provider_user_request = authentik_client.MicrosoftEntraProviderUserRequest() # MicrosoftEntraProviderUserRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.ProvidersApi(api_client)
    o_auth2_provider_request = authentik_client.OAuth2ProviderRequest() # OAuth2ProviderRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.ProvidersApi(api_client)
    o_auth2_dynamic_client_registration_request = authentik_client.OAuth2DynamicClientRegistrationRequest() # OAuth2DynamicClientRegistrationRequest | 

    try:
        api_response = api_instance.providers_oauth2_dcr_create(o_auth2_dynamic_client_registration_request)
        print("The response of ProvidersApi->providers_oauth2_dcr_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProvidersApi->providers_oauth2_dcr_create: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.ProvidersApi(api_client)
    pbm_uuid = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | A UUID string identifying this OAuth2 Dynamic Client Registration.

    try:
        api_instance.providers_oauth2_dcr_destroy(pbm_uuid)
    except Exception as e:
        print("Exception when calling ProvidersApi->providers_oauth2_dcr_destroy: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pbm_uuid** | **UUID**| A UUID string identifying this OAuth2 Dynamic Client Registration. | 
...
> PaginatedOAuth2DynamicClientRegistrationList providers_oauth2_dcr_list(ordering=ordering, page=page, page_size=page_size, provider=provider, search=search)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.providers_oauth2_dcr_list(ordering=ordering, page=page, page_size=page_size, provider=provider, search=search)
        print("The response of ProvidersApi->providers_oauth2_dcr_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProvidersApi->providers_oauth2_dcr_list: %s\n" % e)
```
...
> OAuth2DynamicClientRegistration providers_oauth2_dcr_partial_update(pbm_uuid, patched_o_auth2_dynamic_client_registration_request=patched_o_auth2_dynamic_client_registration_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.ProvidersApi(api_client)
    pbm_uuid = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | A UUID string identifying this OAuth2 Dynamic Client Registration.
    patched_o_auth2_dynamic_client_registration_request = authentik_client.PatchedOAuth2DynamicClientRegistrationRequest() # PatchedOAuth2DynamicClientRegistrationRequest |  (optional)

    try:
        api_response = api_instance.providers_oauth2_dcr_partial_update(pbm_uuid, patched_o_auth2_dynamic_client_registration_request=patched_o_auth2_dynamic_client_registration_request)
        print("The response of ProvidersApi->providers_oauth2_dcr_partial_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProvidersApi->providers_oauth2_dcr_partial_update: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.providers_oauth2_dcr_retrieve(pbm_uuid)
        print("The response of ProvidersApi->providers_oauth2_dcr_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProvidersApi->providers_oauth2_dcr_retrieve: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.providers_oauth2_dcr_update(pbm_uuid, o_auth2_dynamic_client_registration_request)
        print("The response of ProvidersApi->providers_oauth2_dcr_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProvidersApi->providers_oauth2_dcr_update: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    client_type = authentik_client.ClientTypeEnum() # ClientTypeEnum |  (optional)
    include_claims_in_id_token = True # bool |  (optional)
    issuer_mode = authentik_client.IssuerModeEnum() # IssuerModeEnum |  (optional)
    name = 'name_example' # str |  (optional)
    ordering = 'ordering_example' # str | Which field to use when ordering the results. (optional)
    page = 56 # int | A page number within the paginated result set. (optional)
    page_size = 56 # int | Number of results to return per page. (optional)
    ...
    sub_mode = authentik_client.SubModeEnum() # SubModeEnum |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.ProvidersApi(api_client)
    id = 56 # int | A unique integer value identifying this OAuth2/OpenID Provider.
    patched_o_auth2_provider_request = authentik_client.PatchedOAuth2ProviderRequest() # PatchedOAuth2ProviderRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.ProvidersApi(api_client)
    proxy_provider_request = authentik_client.ProxyProviderRequest() # ProxyProviderRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.ProvidersApi(api_client)
    id = 56 # int | A unique integer value identifying this Proxy Provider.
    patched_proxy_provider_request = authentik_client.PatchedProxyProviderRequest() # PatchedProxyProviderRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.ProvidersApi(api_client)
    rac_provider_request = authentik_client.RACProviderRequest() # RACProviderRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.ProvidersApi(api_client)
    id = 56 # int | A unique integer value identifying this RAC Provider.
    patched_rac_provider_request = authentik_client.PatchedRACProviderRequest() # PatchedRACProviderRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.ProvidersApi(api_client)
    radius_provider_request = authentik_client.RadiusProviderRequest() # RadiusProviderRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.ProvidersApi(api_client)
    id = 56 # int | A unique integer value identifying this Radius Provider.
    patched_radius_provider_request = authentik_client.PatchedRadiusProviderRequest() # PatchedRadiusProviderRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.ProvidersApi(api_client)
    saml_provider_request = authentik_client.SAMLProviderRequest() # SAMLProviderRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    default_name_id_policy = authentik_client.SAMLNameIDPolicyEnum() # SAMLNameIDPolicyEnum |  (optional)
    ...
    logout_method = authentik_client.SAMLLogoutMethods() # SAMLLogoutMethods |  (optional)
    name = 'name_example' # str |  (optional)
    ...
    sign_logout_response = True # bool |  (optional)
    ...
    sls_binding = authentik_client.SAMLBindingsEnum() # SAMLBindingsEnum |  (optional)
    sls_url = 'sls_url_example' # str |  (optional)
    sp_binding = authentik_client.SAMLBindingsEnum() # SAMLBindingsEnum |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    force_binding = authentik_client.ForceBindingEnum() # ForceBindingEnum |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.ProvidersApi(api_client)
    id = 56 # int | A unique integer value identifying this SAML Provider.
    patched_saml_provider_request = authentik_client.PatchedSAMLProviderRequest() # PatchedSAMLProviderRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.ProvidersApi(api_client)
    scim_provider_request = authentik_client.SCIMProviderRequest() # SCIMProviderRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.ProvidersApi(api_client)
    scim_provider_group_request = authentik_client.SCIMProviderGroupRequest() # SCIMProviderGroupRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.ProvidersApi(api_client)
    id = 56 # int | A unique integer value identifying this SCIM Provider.
    patched_scim_provider_request = authentik_client.PatchedSCIMProviderRequest() # PatchedSCIMProviderRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.providers_scim_sync_object_create(id, sync_object_request)
        print("The response of ProvidersApi->providers_scim_sync_object_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProvidersApi->providers_scim_sync_object_create: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.ProvidersApi(api_client)
    scim_provider_user_request = authentik_client.SCIMProviderUserRequest() # SCIMProviderUserRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.ProvidersApi(api_client)
    ssf_provider_request = authentik_client.SSFProviderRequest() # SSFProviderRequest | 

    try:
        api_response = api_instance.providers_ssf_create(ssf_provider_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.providers_ssf_list(application__isnull=application__isnull, name__iexact=name__iexact, ordering=ordering, page=page, page_size=page_size, search=search)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.ProvidersApi(api_client)
    id = 56 # int | A unique integer value identifying this Shared Signals Framework Provider.
    patched_ssf_provider_request = authentik_client.PatchedSSFProviderRequest() # PatchedSSFProviderRequest |  (optional)

    try:
        api_response = api_instance.providers_ssf_partial_update(id, patched_ssf_provider_request=patched_ssf_provider_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.providers_ssf_retrieve(id)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.providers_ssf_update(id, ssf_provider_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.providers_ssf_used_by_list(id)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    page_size = 56 # int | Number of results to return per page. (optional)
    property_mappings = None # List[UUID] |  (optional)
    saml_version = authentik_client.SamlVersionEnum() # SamlVersionEnum |  (optional)
    search = 'search_example' # str | A search term. (optional)
    session_valid_not_on_or_after = 'session_valid_not_on_or_after_example' # str |  (optional)
    sign_assertion = True # bool |  (optional)
    sign_logout_request = True # bool |  (optional)
