...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    invalid_response_action = authentik_client.InvalidResponseActionEnum() # InvalidResponseActionEnum |  (optional)
...
> bytes flows_instances_export_retrieve(slug)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.FlowsApi(api_client)
    denied_action = authentik_client.DeniedActionEnum() # DeniedActionEnum |  (optional)
    designation = authentik_client.FlowDesignationEnum() # FlowDesignationEnum |  (optional)
