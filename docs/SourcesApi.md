...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SourcesApi->sources_group_connections_plex_destroy: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_plex_list(group=group, ordering=ordering, page=page, page_size=page_size, search=search, source__slug=source__slug)
        print("The response of SourcesApi->sources_group_connections_plex_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourcesApi->sources_group_connections_plex_list: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.SourcesApi(api_client)
    id = 56 # int | A unique integer value identifying this Group Plex Source Connection.
    patched_group_plex_source_connection_request = authentik_client.PatchedGroupPlexSourceConnectionRequest() # PatchedGroupPlexSourceConnectionRequest |  (optional)

    try:
        api_response = api_instance.sources_group_connections_plex_partial_update(id, patched_group_plex_source_connection_request=patched_group_plex_source_connection_request)
        print("The response of SourcesApi->sources_group_connections_plex_partial_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourcesApi->sources_group_connections_plex_partial_update: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_plex_retrieve(id)
        print("The response of SourcesApi->sources_group_connections_plex_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourcesApi->sources_group_connections_plex_retrieve: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_plex_update(id, group_plex_source_connection_request)
        print("The response of SourcesApi->sources_group_connections_plex_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourcesApi->sources_group_connections_plex_update: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_plex_used_by_list(id)
        print("The response of SourcesApi->sources_group_connections_plex_used_by_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourcesApi->sources_group_connections_plex_used_by_list: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SourcesApi->sources_group_connections_saml_destroy: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_saml_list(group=group, ordering=ordering, page=page, page_size=page_size, search=search, source__slug=source__slug)
        print("The response of SourcesApi->sources_group_connections_saml_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourcesApi->sources_group_connections_saml_list: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.SourcesApi(api_client)
    id = 56 # int | A unique integer value identifying this Group SAML Source Connection.
    patched_group_saml_source_connection_request = authentik_client.PatchedGroupSAMLSourceConnectionRequest() # PatchedGroupSAMLSourceConnectionRequest |  (optional)

    try:
        api_response = api_instance.sources_group_connections_saml_partial_update(id, patched_group_saml_source_connection_request=patched_group_saml_source_connection_request)
        print("The response of SourcesApi->sources_group_connections_saml_partial_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourcesApi->sources_group_connections_saml_partial_update: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_saml_retrieve(id)
        print("The response of SourcesApi->sources_group_connections_saml_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourcesApi->sources_group_connections_saml_retrieve: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_saml_update(id, group_saml_source_connection_request)
        print("The response of SourcesApi->sources_group_connections_saml_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourcesApi->sources_group_connections_saml_update: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_saml_used_by_list(id)
        print("The response of SourcesApi->sources_group_connections_saml_used_by_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SourcesApi->sources_group_connections_saml_used_by_list: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.SourcesApi(api_client)
    kerberos_source_request = authentik_client.KerberosSourceRequest() # KerberosSourceRequest | 

    try:
        api_response = api_instance.sources_kerberos_create(kerberos_source_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    kadmin_type = authentik_client.KadminTypeEnum() # KadminTypeEnum |  (optional)
    name = 'name_example' # str |  (optional)
    ordering = 'ordering_example' # str | Which field to use when ordering the results. (optional)
    page = 56 # int | A page number within the paginated result set. (optional)
    page_size = 56 # int | Number of results to return per page. (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.SourcesApi(api_client)
    slug = 'slug_example' # str | 
    patched_kerberos_source_request = authentik_client.PatchedKerberosSourceRequest() # PatchedKerberosSourceRequest |  (optional)

    try:
        api_response = api_instance.sources_kerberos_partial_update(slug, patched_kerberos_source_request=patched_kerberos_source_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_kerberos_retrieve(slug)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_kerberos_sync_status_retrieve(slug)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_kerberos_update(slug, kerberos_source_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_kerberos_used_by_list(slug)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.SourcesApi(api_client)
    ldap_source_request = authentik_client.LDAPSourceRequest() # LDAPSourceRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    sync_group_hierarchy = True # bool |  (optional)
 ...
 **sync_group_hierarchy** | **bool**|  | [optional] 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.SourcesApi(api_client)
    slug = 'slug_example' # str | 
    patched_ldap_source_request = authentik_client.PatchedLDAPSourceRequest() # PatchedLDAPSourceRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.SourcesApi(api_client)
    o_auth_source_request = authentik_client.OAuthSourceRequest() # OAuthSourceRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    group_matching_mode = authentik_client.GroupMatchingModeEnum() # GroupMatchingModeEnum |  (optional)
    ...
    page_size = 56 # int | Number of results to return per page. (optional)
    pbm_uuid = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID |  (optional)
    policy_engine_mode = authentik_client.PolicyEngineMode() # PolicyEngineMode |  (optional)
    ...
    search = 'search_example' # str | A search term. (optional)
    slug = 'slug_example' # str |  (optional)
    user_matching_mode = authentik_client.UserMatchingModeEnum() # UserMatchingModeEnum |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.SourcesApi(api_client)
    slug = 'slug_example' # str | 
    patched_o_auth_source_request = authentik_client.PatchedOAuthSourceRequest() # PatchedOAuthSourceRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.SourcesApi(api_client)
    plex_source_request = authentik_client.PlexSourceRequest() # PlexSourceRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.SourcesApi(api_client)
    slug = 'slug_example' # str | 
    patched_plex_source_request = authentik_client.PatchedPlexSourceRequest() # PatchedPlexSourceRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.SourcesApi(api_client)
    plex_token_redeem_request = authentik_client.PlexTokenRedeemRequest() # PlexTokenRedeemRequest | 
    slug = 'slug_example' # str |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.SourcesApi(api_client)
    saml_source_request = authentik_client.SAMLSourceRequest() # SAMLSourceRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    authentication_flow = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID |  (optional)
    binding_type = authentik_client.BindingTypeEnum() # BindingTypeEnum |  (optional)
    digest_algorithm = authentik_client.DigestAlgorithmEnum() # DigestAlgorithmEnum |  (optional)
    enabled = True # bool |  (optional)
    enrollment_flow = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID |  (optional)
    force_authn = True # bool |  (optional)
    issuer_override = 'issuer_override_example' # str |  (optional)
    managed = 'managed_example' # str |  (optional)
    name = 'name_example' # str |  (optional)
    name_id_policy = authentik_client.SAMLNameIDPolicyEnum() # SAMLNameIDPolicyEnum |  (optional)
    ordering = 'ordering_example' # str | Which field to use when ordering the results. (optional)
    page = 56 # int | A page number within the paginated result set. (optional)
    page_size = 56 # int | Number of results to return per page. (optional)
    pbm_uuid = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID |  (optional)
    ...
    search = 'search_example' # str | A search term. (optional)
    signature_algorithm = authentik_client.SignatureAlgorithmEnum() # SignatureAlgorithmEnum |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.SourcesApi(api_client)
    slug = 'slug_example' # str | 
    patched_saml_source_request = authentik_client.PatchedSAMLSourceRequest() # PatchedSAMLSourceRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.SourcesApi(api_client)
    scim_source_request = authentik_client.SCIMSourceRequest() # SCIMSourceRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.SourcesApi(api_client)
    scim_source_group_request = authentik_client.SCIMSourceGroupRequest() # SCIMSourceGroupRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.SourcesApi(api_client)
    id = 'id_example' # str | A unique value identifying this scim source group.
    patched_scim_source_group_request = authentik_client.PatchedSCIMSourceGroupRequest() # PatchedSCIMSourceGroupRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.SourcesApi(api_client)
    slug = 'slug_example' # str | 
    patched_scim_source_request = authentik_client.PatchedSCIMSourceRequest() # PatchedSCIMSourceRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.SourcesApi(api_client)
    scim_source_user_request = authentik_client.SCIMSourceUserRequest() # SCIMSourceUserRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.SourcesApi(api_client)
    id = 'id_example' # str | A unique value identifying this scim source user.
    patched_scim_source_user_request = authentik_client.PatchedSCIMSourceUserRequest() # PatchedSCIMSourceUserRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_user_connections_all_list(ordering=ordering, page=page, page_size=page_size, search=search, source__slug=source__slug, user=user)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.SourcesApi(api_client)
    id = 56 # int | A unique integer value identifying this user source connection.
    patched_user_source_connection_request = authentik_client.PatchedUserSourceConnectionRequest() # PatchedUserSourceConnectionRequest |  (optional)

    try:
        api_response = api_instance.sources_user_connections_all_partial_update(id, patched_user_source_connection_request=patched_user_source_connection_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.SourcesApi(api_client)
    id = 56 # int | A unique integer value identifying this user source connection.
    user_source_connection_request = authentik_client.UserSourceConnectionRequest() # UserSourceConnectionRequest | 

    try:
        api_response = api_instance.sources_user_connections_all_update(id, user_source_connection_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.SourcesApi(api_client)
    user_kerberos_source_connection_request = authentik_client.UserKerberosSourceConnectionRequest() # UserKerberosSourceConnectionRequest | 

    try:
        api_response = api_instance.sources_user_connections_kerberos_create(user_kerberos_source_connection_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.SourcesApi(api_client)
    id = 56 # int | A unique integer value identifying this User Kerberos Source Connection.
    patched_user_kerberos_source_connection_request = authentik_client.PatchedUserKerberosSourceConnectionRequest() # PatchedUserKerberosSourceConnectionRequest |  (optional)

    try:
        api_response = api_instance.sources_user_connections_kerberos_partial_update(id, patched_user_kerberos_source_connection_request=patched_user_kerberos_source_connection_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_user_connections_kerberos_retrieve(id)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_user_connections_kerberos_update(id, user_kerberos_source_connection_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_user_connections_kerberos_used_by_list(id)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.SourcesApi(api_client)
    user_o_auth_source_connection_request = authentik_client.UserOAuthSourceConnectionRequest() # UserOAuthSourceConnectionRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_user_connections_oauth_list(ordering=ordering, page=page, page_size=page_size, search=search, source__slug=source__slug, user=user)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.SourcesApi(api_client)
    id = 56 # int | A unique integer value identifying this User OAuth Source Connection.
    patched_user_o_auth_source_connection_request = authentik_client.PatchedUserOAuthSourceConnectionRequest() # PatchedUserOAuthSourceConnectionRequest |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.SourcesApi(api_client)
    user_plex_source_connection_request = authentik_client.UserPlexSourceConnectionRequest() # UserPlexSourceConnectionRequest | 

    try:
        api_response = api_instance.sources_user_connections_plex_create(user_plex_source_connection_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_user_connections_plex_list(ordering=ordering, page=page, page_size=page_size, search=search, source__slug=source__slug, user=user)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.SourcesApi(api_client)
    id = 56 # int | A unique integer value identifying this User Plex Source Connection.
    patched_user_plex_source_connection_request = authentik_client.PatchedUserPlexSourceConnectionRequest() # PatchedUserPlexSourceConnectionRequest |  (optional)

    try:
        api_response = api_instance.sources_user_connections_plex_partial_update(id, patched_user_plex_source_connection_request=patched_user_plex_source_connection_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_user_connections_plex_update(id, user_plex_source_connection_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.SourcesApi(api_client)
    user_saml_source_connection_request = authentik_client.UserSAMLSourceConnectionRequest() # UserSAMLSourceConnectionRequest | 
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_user_connections_saml_list(ordering=ordering, page=page, page_size=page_size, search=search, source__slug=source__slug, user=user)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.SourcesApi(api_client)
    id = 56 # int | A unique integer value identifying this User SAML Source Connection.
    patched_user_saml_source_connection_request = authentik_client.PatchedUserSAMLSourceConnectionRequest() # PatchedUserSAMLSourceConnectionRequest |  (optional)
