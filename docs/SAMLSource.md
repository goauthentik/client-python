...
**issuer_override** | **str** | Also known as Entity ID. Defaults to the Metadata URL. | [optional] 
**url_issuer** | **str** | Get the resolved Issuer, falling back to the metadata URL when unset | [readonly] 
...
**force_authn** | **bool** | When enabled, the IdP will re-authenticate the user even if a session exists. | [optional] 
