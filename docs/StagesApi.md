...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    account_lockdown_stage_request = authentik_client.AccountLockdownStageRequest() # AccountLockdownStageRequest | 

    try:
        api_response = api_instance.stages_account_lockdown_create(account_lockdown_stage_request)
        print("The response of StagesApi->stages_account_lockdown_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_account_lockdown_create: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.StagesApi(api_client)
    stage_uuid = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | A UUID string identifying this Account Lockdown Stage.

    try:
        api_instance.stages_account_lockdown_destroy(stage_uuid)
    except Exception as e:
        print("Exception when calling StagesApi->stages_account_lockdown_destroy: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **stage_uuid** | **UUID**| A UUID string identifying this Account Lockdown Stage. | 
...
> PaginatedAccountLockdownStageList stages_account_lockdown_list(deactivate_user=deactivate_user, delete_sessions=delete_sessions, name=name, ordering=ordering, page=page, page_size=page_size, revoke_tokens=revoke_tokens, search=search, self_service_completion_flow=self_service_completion_flow, set_unusable_password=set_unusable_password, stage_uuid=stage_uuid)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.StagesApi(api_client)
    deactivate_user = True # bool |  (optional)
    delete_sessions = True # bool |  (optional)
    name = 'name_example' # str |  (optional)
    ordering = 'ordering_example' # str | Which field to use when ordering the results. (optional)
    page = 56 # int | A page number within the paginated result set. (optional)
    page_size = 56 # int | Number of results to return per page. (optional)
    revoke_tokens = True # bool |  (optional)
    search = 'search_example' # str | A search term. (optional)
    self_service_completion_flow = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID |  (optional)
    set_unusable_password = True # bool |  (optional)
    stage_uuid = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID |  (optional)

    try:
        api_response = api_instance.stages_account_lockdown_list(deactivate_user=deactivate_user, delete_sessions=delete_sessions, name=name, ordering=ordering, page=page, page_size=page_size, revoke_tokens=revoke_tokens, search=search, self_service_completion_flow=self_service_completion_flow, set_unusable_password=set_unusable_password, stage_uuid=stage_uuid)
        print("The response of StagesApi->stages_account_lockdown_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_account_lockdown_list: %s\n" % e)
```
 ...
 **self_service_completion_flow** | **UUID**|  | [optional] 
 **set_unusable_password** | **bool**|  | [optional] 
...
> AccountLockdownStage stages_account_lockdown_partial_update(stage_uuid, patched_account_lockdown_stage_request=patched_account_lockdown_stage_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.StagesApi(api_client)
    stage_uuid = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID | A UUID string identifying this Account Lockdown Stage.
    patched_account_lockdown_stage_request = authentik_client.PatchedAccountLockdownStageRequest() # PatchedAccountLockdownStageRequest |  (optional)

    try:
        api_response = api_instance.stages_account_lockdown_partial_update(stage_uuid, patched_account_lockdown_stage_request=patched_account_lockdown_stage_request)
        print("The response of StagesApi->stages_account_lockdown_partial_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_account_lockdown_partial_update: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.stages_account_lockdown_retrieve(stage_uuid)
        print("The response of StagesApi->stages_account_lockdown_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_account_lockdown_retrieve: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.stages_account_lockdown_update(stage_uuid, account_lockdown_stage_request)
        print("The response of StagesApi->stages_account_lockdown_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_account_lockdown_update: %s\n" % e)
```
...
> List[UsedBy] stages_account_lockdown_used_by_list(stage_uuid)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.stages_account_lockdown_used_by_list(stage_uuid)
        print("The response of StagesApi->stages_account_lockdown_used_by_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_account_lockdown_used_by_list: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    auth_type = authentik_client.AuthTypeEnum() # AuthTypeEnum |  (optional)
    configure_flow = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID |  (optional)
    friendly_name = 'friendly_name_example' # str |  (optional)
    ...
    page = 56 # int | A page number within the paginated result set. (optional)
    page_size = 56 # int | Number of results to return per page. (optional)
    provider = authentik_client.ProviderEnum() # ProviderEnum |  (optional)
    search = 'search_example' # str | A search term. (optional)
    stage_uuid = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    api_instance = authentik_client.StagesApi(api_client)
    configure_flow = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID |  (optional)
    digits = authentik_client.DigitsEnum() # DigitsEnum |  (optional)
    friendly_name = 'friendly_name_example' # str |  (optional)
    name = 'name_example' # str |  (optional)
    ordering = 'ordering_example' # str | Which field to use when ordering the results. (optional)
    page = 56 # int | A page number within the paginated result set. (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    name = 'name_example' # str |  (optional)
    not_configured_action = authentik_client.NotConfiguredActionEnum() # NotConfiguredActionEnum |  (optional)
    ordering = 'ordering_example' # str | Which field to use when ordering the results. (optional)
    page = 56 # int | A page number within the paginated result set. (optional)
    page_size = 56 # int | Number of results to return per page. (optional)
    search = 'search_example' # str | A search term. (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.StagesApi(api_client)
    authenticator_attachment = authentik_client.AuthenticatorAttachmentEnum() # AuthenticatorAttachmentEnum |  (optional)
    configure_flow = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID |  (optional)
    ...
    page = 56 # int | A page number within the paginated result set. (optional)
    page_size = 56 # int | Number of results to return per page. (optional)
    resident_key_requirement = authentik_client.UserVerificationEnum() # UserVerificationEnum |  (optional)
    search = 'search_example' # str | A search term. (optional)
    user_verification = authentik_client.UserVerificationEnum() # UserVerificationEnum |  (optional)
...
```python
import authentik_client
from authentik_client.models.consent_mode_enum import ConsentModeEnum
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    mode = authentik_client.ConsentModeEnum() # ConsentModeEnum |  (optional)
    name = 'name_example' # str |  (optional)
    ordering = 'ordering_example' # str | Which field to use when ordering the results. (optional)
    page = 56 # int | A page number within the paginated result set. (optional)
    page_size = 56 # int | Number of results to return per page. (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.stages_mtls_create(mutual_tls_stage_request)
        print("The response of StagesApi->stages_mtls_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_mtls_create: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling StagesApi->stages_mtls_destroy: %s\n" % e)
```
...
# **stages_mtls_list**
> PaginatedMutualTLSStageList stages_mtls_list(cert_attribute=cert_attribute, certificate_authorities=certificate_authorities, mode=mode, name=name, ordering=ordering, page=page, page_size=page_size, search=search, stage_uuid=stage_uuid, user_attribute=user_attribute)
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.StagesApi(api_client)
    cert_attribute = authentik_client.CertAttributeEnum() # CertAttributeEnum |  (optional)
    certificate_authorities = None # List[UUID] |  (optional)
    mode = authentik_client.StageModeEnum() # StageModeEnum |  (optional)
    name = 'name_example' # str |  (optional)
    ordering = 'ordering_example' # str | Which field to use when ordering the results. (optional)
    page = 56 # int | A page number within the paginated result set. (optional)
    page_size = 56 # int | Number of results to return per page. (optional)
    search = 'search_example' # str | A search term. (optional)
    stage_uuid = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID |  (optional)
    user_attribute = authentik_client.UserAttributeEnum() # UserAttributeEnum |  (optional)

    try:
        api_response = api_instance.stages_mtls_list(cert_attribute=cert_attribute, certificate_authorities=certificate_authorities, mode=mode, name=name, ordering=ordering, page=page, page_size=page_size, search=search, stage_uuid=stage_uuid, user_attribute=user_attribute)
        print("The response of StagesApi->stages_mtls_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_mtls_list: %s\n" % e)
```
...
> MutualTLSStage stages_mtls_partial_update(stage_uuid, patched_mutual_tls_stage_request=patched_mutual_tls_stage_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.stages_mtls_partial_update(stage_uuid, patched_mutual_tls_stage_request=patched_mutual_tls_stage_request)
        print("The response of StagesApi->stages_mtls_partial_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_mtls_partial_update: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StagesApi->stages_mtls_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_mtls_retrieve: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.stages_mtls_update(stage_uuid, mutual_tls_stage_request)
        print("The response of StagesApi->stages_mtls_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_mtls_update: %s\n" % e)
```
...
> List[UsedBy] stages_mtls_used_by_list(stage_uuid)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StagesApi->stages_mtls_used_by_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_mtls_used_by_list: %s\n" % e)
```
...
> PaginatedPasswordStageList stages_password_list(allow_show_password=allow_show_password, configure_flow=configure_flow, failed_attempts_before_cancel=failed_attempts_before_cancel, name=name, ordering=ordering, page=page, page_size=page_size, search=search)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.stages_password_list(allow_show_password=allow_show_password, configure_flow=configure_flow, failed_attempts_before_cancel=failed_attempts_before_cancel, name=name, ordering=ordering, page=page, page_size=page_size, search=search)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    search = 'search_example' # str | A search term. (optional)
    type = authentik_client.PromptTypeEnum() # PromptTypeEnum |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.stages_redirect_create(redirect_stage_request)
        print("The response of StagesApi->stages_redirect_create:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_redirect_create: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling StagesApi->stages_redirect_destroy: %s\n" % e)
```
...
> PaginatedRedirectStageList stages_redirect_list(name=name, ordering=ordering, page=page, page_size=page_size, search=search)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.stages_redirect_list(name=name, ordering=ordering, page=page, page_size=page_size, search=search)
        print("The response of StagesApi->stages_redirect_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_redirect_list: %s\n" % e)
```
...
> RedirectStage stages_redirect_partial_update(stage_uuid, patched_redirect_stage_request=patched_redirect_stage_request)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.stages_redirect_partial_update(stage_uuid, patched_redirect_stage_request=patched_redirect_stage_request)
        print("The response of StagesApi->stages_redirect_partial_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_redirect_partial_update: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StagesApi->stages_redirect_retrieve:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_redirect_retrieve: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.stages_redirect_update(stage_uuid, redirect_stage_request)
        print("The response of StagesApi->stages_redirect_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_redirect_update: %s\n" % e)
```
...
> List[UsedBy] stages_redirect_used_by_list(stage_uuid)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of StagesApi->stages_redirect_used_by_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StagesApi->stages_redirect_used_by_list: %s\n" % e)
```
...
with authentik_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = authentik_client.StagesApi(api_client)
    geoip_binding = authentik_client.GeoipBindingEnum() # GeoipBindingEnum |  (optional)
    name = 'name_example' # str |  (optional)
    network_binding = authentik_client.NetworkBindingEnum() # NetworkBindingEnum |  (optional)
    ordering = 'ordering_example' # str | Which field to use when ordering the results. (optional)
    page = 56 # int | A page number within the paginated result set. (optional)
    page_size = 56 # int | Number of results to return per page. (optional)
    remember_device = 'remember_device_example' # str |  (optional)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    search = 'search_example' # str | A search term. (optional)
    stage_uuid = UUID('38400000-8cf0-11bd-b23e-10b96e4ef00d') # UUID |  (optional)
    user_creation_mode = authentik_client.UserCreationModeEnum() # UserCreationModeEnum |  (optional)
    user_path_template = 'user_path_template_example' # str |  (optional)
    user_type = authentik_client.UserTypeEnum() # UserTypeEnum |  (optional)
