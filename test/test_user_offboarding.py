...
class TestUserOffboarding(unittest.TestCase):
    """UserOffboarding unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserOffboarding:
        """Test UserOffboarding
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserOffboarding`
        """
        ...
        if include_optional:
            return UserOffboarding(
                ...
                revoke_tokens = True,
                status = 'pending',
                created_by_obj = authentik_client.models.partial_user.PartialUser(
                    pk = 56, 
                    username = 'A', 
                    name = '', 
                    is_active = True, 
